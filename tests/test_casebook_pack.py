"""Regression checks for the notion-svc-profile-pipe casebook."""
...
from casebook.harness import assert_expected, notion_svc_profile_pipe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(notion_svc_profile_pipe_summary(), assert_expected())
