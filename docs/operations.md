...
`notion-svc-profile-pipe` is centered on backend services work in Kotlin. The technical target is: Design a Kotlin verification harness for profile systems, covering visual model generation, layout fixtures, and failure-oriented tests.
...
The score is deterministic. The current threshold is 170. Risk has a penalty of 6, latency has a penalty of 4, and weight contributes a bonus of 4.
